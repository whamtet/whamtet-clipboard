...
launch from the command line:
    ...
    $ lein run -m whamtet-clipboard.web
...
get the app created:
    ...
    $ heroku apps:create whamtet-clipboard
    Creating whamtet-clipboard... done, stack is cedar
    http://whamtet-clipboard.herokuapp.com/ | git@heroku.com:whamtet-clipboard.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://whamtet-clipboard.herokuapp.com deployed to Heroku

    To git@heroku.com:whamtet-clipboard.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://whamtet-clipboard.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@whamtet-clipboard.herokuapp.com/repl
